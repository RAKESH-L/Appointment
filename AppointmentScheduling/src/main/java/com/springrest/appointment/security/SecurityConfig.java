...
//	
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.POST,"/api/course/add").permitAll()
		...
		.antMatchers(HttpMethod.POST,"/api/appointment/add/{cid}/{sid}").permitAll()
		.antMatchers(HttpMethod.PUT,"/api/appointment/status/{status}/{id}").permitAll()
		.antMatchers(HttpMethod.GET,"/api/appointment/all/{status}").permitAll()
